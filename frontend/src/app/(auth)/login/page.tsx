...
export default function LoginPage() {
  ...
  // Mock login: just go to dashboard immediately
    ...
    <div className="flex flex-col flex-1 p-8 sm:p-12 md:p-16 relative">
      ...
      <div className="flex justify-between items-center mb-16">
        ...
        <div className="text-sm">
          ...
          <Link href="/signup" className="border border-gray-200 px-3 py-1.5 rounded-md hover:bg-gray-50 transition-colors">
            Sign up
          </Link>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center max-w-sm mx-auto w-full">
        ...
        <div className="w-full space-y-4">
          <Button variant="outline" className="w-full h-12 rounded-lg text-base font-normal flex items-center justify-center gap-3 cursor-pointer" onClick={handleLogin}>
          ...
          <Button className="w-full h-12 rounded-lg text-base font-normal bg-[#332c39] hover:bg-[#252029] cursor-pointer" onClick={handleLogin}>
            Log in with email
          </Button>
        </div>
      </div>
